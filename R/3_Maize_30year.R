...
#prep the maize -----
maizeNiche <- terra::rast("data/data-raw/paleocar/mfn_paleocar.tif")
...
terra::writeRaster(maizeNiche_30yrAverage, 
                   here::here("data/data-derived/maizeNiche/maizeNiche_30yrAverage_600_1300.tif"))
...
#load Maize
maizeNiche_30yrAverage <- terra::rast("data/data-derived/maizeNiche/maizeNiche_30yrAverage_600_1300.tif") 
